...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     raspberrymockproxy >> Edge( label='statoAshStorage', **eventedgeattr, decorate='true', fontcolor='red') >> sys
     raspberrymockproxy >> Edge( label='num_RP', **eventedgeattr, decorate='true', fontcolor='red') >> sys
