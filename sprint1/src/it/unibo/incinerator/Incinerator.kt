		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t024",targetState="turnOn",cond=whenDispatch("activationCommand"))
				}	 
				state("turnOn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t025",targetState="handleStartBurning",cond=whenDispatch("startBurning"))
				}	 
				state("handleStartBurning") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t026",targetState="handleEndBurning",cond=whenTimeout("local_tout_"+name+"_handleStartBurning"))   
				}	 
				state("handleEndBurning") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t027",targetState="handleStartBurning",cond=whenDispatch("startBurning"))
				}	 
			}
		}
} 
