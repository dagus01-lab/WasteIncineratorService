		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t05",targetState="turnOn",cond=whenDispatch("activationCommand"))
				}	 
				state("turnOn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t06",targetState="handleStartBurning",cond=whenDispatch("startBurning"))
				}	 
				state("handleStartBurning") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t07",targetState="handleEndBurning",cond=whenTimeout("local_tout_"+name+"_handleStartBurning"))   
				}	 
				state("handleEndBurning") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t08",targetState="handleStartBurning",cond=whenDispatch("startBurning"))
				}	 
			}
		}
} 
