		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t014",targetState="handleAshes",cond=whenDispatch("newAshes"))
				}	 
				state("handleAshes") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="simulateRemoveAshes",cond=whenTimeout("local_tout_"+name+"_handleAshes"))   
					transition(edgeName="t016",targetState="handleAshes",cond=whenDispatch("newAshes"))
				}	 
				state("simulateRemoveAshes") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t017",targetState="handleAshes",cond=whenDispatch("newAshes"))
				}	 
			}
		}
} 
