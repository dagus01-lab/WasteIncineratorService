...
%====================================================================================
dispatch( arrived_RP, arrived_RP(SOURCE,N) ). %command that simulate the arrival of new RP
...
request( infoScale, infoScale(X) ).
reply( infoScaleReply, infoScaleReply(X) ).  %%for infoScale
request( infoMonitoringDevice, infoMonitoringDevice(X) ).
reply( infoMonitoringDeviceReply, infoMonitoringDeviceReply(X) ).  %%for infoMonitoringDevice
%====================================================================================
context(ctx_waste_incinerator_service, "localhost",  "TCP", "8125").
context(ctxbasicrobot, "127.0.0.1",  "TCP", "8020").
context(ctxmonitoringdevice, "192.168.114.105",  "TCP", "8100").
context(ctxscale, "192.168.1.105",  "TCP", "8101").
