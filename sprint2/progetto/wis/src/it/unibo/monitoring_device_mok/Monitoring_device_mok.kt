		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition( edgeName="goto",targetState="emitState", cond=doswitch() )
				}	 
				state("emitState") { //this:State
					action { //it:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t038",targetState="handleAshes",cond=whenDispatch("newAshes"))
				}	 
				state("handleAshes") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t039",targetState="simulateRemoveAshes",cond=whenTimeout("local_tout_"+name+"_handleAshes"))   
