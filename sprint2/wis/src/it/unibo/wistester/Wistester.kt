		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t031",targetState="handleinfo",cond=whenRequest("info"))
				}	 
				state("handleinfo") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="failure",cond=whenTimeout("local_tout_"+name+"_handleinfo"))   
					transition(edgeName="t033",targetState="success",cond=whenDispatch("newAshes"))
				}	 
