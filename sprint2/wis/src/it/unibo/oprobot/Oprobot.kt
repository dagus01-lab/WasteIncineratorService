		...
		return { //this:ActionBasciFsm
				...
				state("engage") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t07",targetState="noResponse",cond=whenTimeout("local_tout_"+name+"_engage"))   
					transition(edgeName="t08",targetState="waitingWorking",cond=whenReply("engagedone"))
					transition(edgeName="t09",targetState="end",cond=whenReply("engagerefused"))
				}	 
				...
				state("waitingWorking") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t010",targetState="takeRP",cond=whenDispatch("arrived_RP"))
				}	 
				state("takeRP") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t011",targetState="bringRPtoBURNIN",cond=whenReply("moverobotdone"))
					transition(edgeName="t012",targetState="exit",cond=whenReply("moverobotfailed"))
				}	 
				state("bringRPtoBURNIN") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="returnHOME",cond=whenReply("moverobotdone"))
					transition(edgeName="t014",targetState="exit",cond=whenReply("moverobotfailed"))
				}	 
				state("returnHOME") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="waitingForIncinerator",cond=whenReply("moverobotdone"))
				...
				state("waitingForIncinerator") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t017",targetState="takeAshFromBURNOUT",cond=whenEvent("endBurning"))
				}	 
				state("takeAshFromBURNOUT") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t018",targetState="bringAshtoASHOUT",cond=whenReply("moverobotdone"))
				...
				state("bringAshtoASHOUT") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t020",targetState="restartJob",cond=whenReply("moverobotdone"))
				...
				state("restartJob") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t022",targetState="takeRpBeforeFinishPlan",cond=whenDispatch("arrived_RP"))
					transition(edgeName="t023",targetState="waitingWorking",cond=whenReply("moverobotdone"))
				...
				state("takeRpBeforeFinishPlan") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t025",targetState="testko",cond=whenReply("moverobotdone"))
					transition(edgeName="t026",targetState="takeRP",cond=whenReply("moverobotfailed"))
				}	 
